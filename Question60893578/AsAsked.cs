...
namespace Question60893578.AsAsked
{
    ...
    public class Tests
    {
        ...
        public void TestProperties_PropertyWithEmptyName_HasCustomError()
        {
            ...
            validator.ShouldHaveValidationErrorFor(x => x.TestProperties, testClass).WithErrorMessage($"TestProperty {property.Id} name can't be null or empty");
        }
